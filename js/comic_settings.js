...
<p>Happy Easter Monday, good thing there's two Easters otherwise this would be a late holiday comic AGAIN, kinda ironic as Easter Monday was meant to extend the celebration Jesus' resurrection before he was gone again.</p>            `,
        ...
        pgNum: 24,
        title: ``,
        date: writeDate(2026, 4, 13),
        altText: "Tractor",
        imageFiles: 1,
        authorNotes: `
            <p>Did this type of question even exist back then, eh whatever, it's fiction.</p>
            `
    },
            {
        pgNum: 25,
        title: `Millenials`,
        date: writeDate(2026, 4, 26),
        altText: "Vine",
        imageFiles: 1,
        authorNotes: `
            <p></p>
        ...
        imageFiles: 1,
        authorNotes: `
            <p>Happy birthday to Thomas Fulp, the 20th anniversary of Picos School day and to all of the above on April 30th, even National Larry Day</p>
            `
    },
               {
        pgNum: 27,
        ...
        imageFiles: 1,
        authorNotes: `
            <p>First indulgent Comic because of the amount of BIKINIS. This would be posted on Constitution Day in Japan so happy anniversary to Japans establishment of a new Constitution after WW2.</p>
            `
    },
];
